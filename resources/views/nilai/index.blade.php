...
<div class="row">
    <div class="col-lg-6">
        <div class="card mb-4">
            <div class="card-body">
                <h6 class="m-0 font-weight-bold text-primary">Daftarkan Guru</h6>
    ...
    <div class="col-lg-6">
        <div class="card mb-4" id="daftar-alternatif">
            <div class="card-body">
                <h4 class="mb-2 font-weight-bold text-primary">Guru yang sudah terdaftar</h4>
...
<div class="col-lg-12 mb-4">
    ...
    <div class="card mb-4" id="{{ str_replace(' ', '-', $key) }}">
        <div class="card-header py-3 row">
            <h4 class="col-md-6 mb-2 font-weight-bold text-primary">Nama Guru : {{ $key }}</h4>
